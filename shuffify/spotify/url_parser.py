...
_URL_PATTERNS = [
    # Standard and internationalized URLs:
    ...
    re.compile(
        ...
        r"(?:/intl-[a-z]{2}(?:-[a-zA-Z]{2})?)?"
        r"/playlist/([a-zA-Z0-9]{22})"
        r"/?(?:\?.*)?$"
    ),
    # Embed URLs: https://open.spotify.com/embed/playlist/37i9dQZF1DXcBWIGoYBM5M
    re.compile(
        r"(?:https?://)?open\.spotify\.com"
        r"/embed/playlist/([a-zA-Z0-9]{22})"
        r"/?(?:\?.*)?$"
    ),
